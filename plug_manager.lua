...
local update = redis:get(LITNECK..":VERSION")
...
redis:srem(LITNECK..':PLUGINS_FILE:',matches[2])
...
download_file(file_plug,'./plugins/'..matches[2]..".lua") redis:sadd(LITNECK..':PLUGINS_FILE:',matches[2]) reload_plugins() else
...
if not we_sudo(msg)  then return "📛*￤* هذا الاوامر للمطور الاساسي فقط 🛠" end
local num_update = https.request('https://api.th3LITNECK.com/version/') -- تحقق من التحديث اذا كان موجود او لا
if num_update > update then
sendMsg(msg.to.id,msg.id_,'🔛*¦* يوجد تحديث جديد الان \n📡*¦* جاري تنزيل وتثبيت التحديث  ...','md')
download_file('https://raw.githubusercontent.com/TH3BS/LITNECK/master/inc/BOT.lua','./inc/BOT.lua')
download_file('https://raw.githubusercontent.com/TH3BS/LITNECK/master/inc/functions.lua','./inc/functions.lua')
download_file('https://raw.githubusercontent.com/TH3BS/LITNECK/master/inc/locks.lua','./inc/locks.lua')
download_file('https://raw.githubusercontent.com/TH3BS/LITNECK/master/plugins/cmd_help.lua','./plugins/cmd_help.lua')
download_file('https://raw.githubusercontent.com/TH3BS/LITNECK/master/plugins/plug_manager.lua','./plugins/plug_manager.lua')
download_file('https://raw.githubusercontent.com/TH3BS/LITNECK/master/plugins/proc_msgs.lua','./plugins/proc_msgs.lua')
download_file('https://raw.githubusercontent.com/TH3BS/LITNECK/master/plugins/rdod_bot.lua','./plugins/rdod_bot.lua')
download_file('https://raw.githubusercontent.com/TH3BS/LITNECK/master/plugins/super_group.lua','./plugins/super_group.lua')
redis:set(LITNECK..":VERSION",num_update)
sendMsg(msg.to.id,msg.id_,'🔝*┇* تم تحديث السورس الى اصدار *v'..redis:get(LITNECK..":VERSION")..'*\n📟*┇* سوف يتم اعاده تشغيل السورس انتظر ثواني ...','md')
sleep(1)
RELOAD_BOT(msg)
else
...
end sendMsg(msg.to.id,msg.id_,'📦*¦* تم رفع آلنسـخهہ‏‏ آلآحتيآطـيهہ\n⚖️*¦* حآليآ عدد مـجمـوعآتگ هہ‏‏يهہ‏‏ *'..#redis:smembers(LITNECK..'group:ids')..'* 🌿\n✓','md')
